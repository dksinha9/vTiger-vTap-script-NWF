var Potentials_Component_Popup = VTAP.Component.Core.extend({
    ...
    mounted() {
        // Load current deal data when modal is mounted
    ...
    methods: {
        onok(event) {
            ...
            if (!this.pppoeUsername || !this.internetStatus) {
                VTAP.Utility.ShowErrorNotification("Missing required data.");
                return;
            }
            ...
            // Step 1: Get PPPoE ID
            VTAP.CustomApi.Post('Find PPPoE ID on Netwire Fiber Radius Server', {
                ...
                if (!userRecords.length || !userRecords[0]['.id']) {
                    ...
                    VTAP.Utility.ShowErrorNotification("PPPoE user not found on Netwire.");
                    return;
                }
                ...
                // Step 2: Enable/Disable Internet
                VTAP.CustomApi.Post(apiName, {
                    ...
                    if (error) {
                        ...
                        VTAP.Utility.ShowErrorNotification("Failed to update internet access.");
                        return;
                    }

                    VTAP.Utility.ShowSuccessNotification(`Internet access ${selectedStatus.toLowerCase()} successfully.`);
                    this.hidePopup();
                });
            });
        },
